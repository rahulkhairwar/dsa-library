package com.codeforces.competitions.educational.year2018.round52;
...
public class Tester
{
	public static void main(String[] args)
	{
		...
		List<TestCase> testCases = readTestCases("/Users/rahulkhairwar/Documents/IntelliJ IDEA Workspace/Competitive Programming/src/com/codeforces/competitions/educational/year2018/round52/B.xml");
		...
		for (int i = 0; i < testCases.size(); i++)
		{
			...
			new TaskB(inputStream, outputStream);
