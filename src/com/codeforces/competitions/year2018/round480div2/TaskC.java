...
//		BufferedReader in;
		...
		void solve() throws IOException
		{
			...
			for (int i = 0; i < n; i++)
			{
				...
				while (left >= 0 && (col[left] == -1 || !found[left]) && rem > 0)
				{
//					System.out.println("****l : " + left + ", col[l] : " + col[left] + ", rem : " + rem);
					left--;
					rem--;

/*					if (left >= 0 && col[left] != -1)
					{
						System.out.println("\tleft : " + left + ", col[left] : " + col[left] + ", fd[col[l]] : " +
								found[left]);
					}*/
				}
				...
				while (right < 256 && col[right] == -1 && rem > 0)
				{
					right++;
					rem--;
				}
