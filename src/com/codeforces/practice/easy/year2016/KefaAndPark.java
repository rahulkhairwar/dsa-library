...
public class KefaAndPark
{
	...
	static class Solver
	{
		...
		void dfs(int node, int consecutiveCount)
		{
			...
			if (temp.hasCats && consecutiveCount + 1 > m)
				return;
			...
			while (iterator.hasNext())
			{
				...
				{
					isLeaf = false;
					dfs(curr, temp.hasCats ? consecutiveCount + 1 : 0);
				}
			}
		...
		class Node
		{
			boolean visited, hasCats;
			List<Integer> adj;

			public Node(boolean hasCats)
			{
