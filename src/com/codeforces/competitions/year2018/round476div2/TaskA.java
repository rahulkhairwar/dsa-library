...
public class TaskA
{
	...
	{
		int people, airplanes, eachSheet, pack;
//		BufferedReader in;
		InputReader in;
		PrintWriter out;
		...
		{
			people = in.nextInt();
			airplanes = in.nextInt();
			eachSheet = in.nextInt();
			pack = in.nextInt();

			int reqSheets = (int) Math.ceil(airplanes / (double) eachSheet);
			int packets = (int) Math.ceil(reqSheets * people / (double) pack);
