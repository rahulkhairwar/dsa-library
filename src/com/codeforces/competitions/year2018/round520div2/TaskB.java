...
//				System.out.println("key : " + key + ", val : " + entry.getValue());
				...
				minCnt = Math.min(minCnt, entry.getValue());
			}
...
//			System.out.println("mc : " + maxCnt + ", min : " + minCnt + ", isP : " + isPowerOf2(maxCnt));

			if (isPowerOf2(maxCnt))
			{
				if (minCnt != maxCnt)
					out.println(getPower(maxCnt) + 1);
				else
					out.println(getPower(maxCnt));
			}
			else
			{
//				System.out.println("next : " + nextPowerOf2(maxCnt));
				out.println(getPower(nextPowerOf2(maxCnt)) + 1);
			}
		}

		long nextPowerOf2(long x)
		{
