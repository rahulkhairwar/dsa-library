...
//		BufferedReader in;
		...
		void solve() throws IOException
		{
			...
			while (frogs > 0)
			{
//				Map.Entry<Integer, Integer> entry = map.floorEntry(len);
//
//				if (entry == null)
//					break;
...
//				int temp = entry.getKey() + len;
				int temp = len;
				int min = (int) 1e5;

				while (temp < width)
				{
					Map.Entry<Integer, Integer> next = map.floorEntry(temp);
...
//					min = Math.min(min, next.getValue());
					temp = key + len;
				}
