...
public class TaskB
{
	...
	static class Solver implements Runnable
	{
		...
		void solve() throws IOException
		{
			...
			int[] poss = new int[]{31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31, 31, 28, 31, 30, 31, 30, 31, 31,
					30, 31, 30, 31, 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31, 31, 29, 31, 30, 31, 30, 31, 31,
					30, 31, 30, 31, 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31, 31, 28, 31, 30, 31, 30, 31, 31,
			...
			if (months.indexOf(given.toString()) >= 0)
				out.println("YES");
			else
				out.println("NO");
		}
