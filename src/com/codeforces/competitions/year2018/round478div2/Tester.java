...
public class Tester
{
	public static void main(String[] args)
	{
		...
		List<TestCase> testCases = readTestCases("/Users/rahulkhairwar/Documents/IntelliJ IDEA Workspace/Competitive Programming/src/com/codeforces/competitions/year2018/round478div2/D.xml");
		...
		for (int i = 0; i < testCases.size(); i++)
		{
			...
			new TaskD(inputStream, outputStream);
