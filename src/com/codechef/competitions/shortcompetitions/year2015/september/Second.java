package com.codechef.competitions.shortcompetitions.year2015.september;
...
class Second
{
	...
	static int contains(int el, int ar[], int l)
	{
		if (el >= ar[l - 1])
			return -1;
