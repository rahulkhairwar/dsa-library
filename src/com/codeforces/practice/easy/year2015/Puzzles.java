...
public final class Puzzles
{
	...
	public static void main(String[] args)
	{
		...
		reader = puzzles.new InputReader(System.in);
		writer = puzzles.new OutputWriter(System.out);
	...
	public static void getAttributes()
	{
		...
		for (int i = 0, j = n - 1; j < m; i++, j++)
			if (sizes[j] - sizes[i] < minimum)
				minimum = sizes[j] - sizes[i];
