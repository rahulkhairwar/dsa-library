	...
	static class Solver
	{
		...
		void solve(int testNumber, InputReader in, OutputWriter out)
		{
			...
			while (t-- > 0)
			{
				...
				activities = Integer.parseInt(tokens[0]);
				origin = tokens[1];
				...
				while (activities-- > 0)
				{
					...
					if (tokens[0].equals("CONTEST_WON"))
					{
					...
					else if (tokens[0].equals("TOP_CONTRIBUTOR"))
						laddus += 300;
					else if (tokens[0].equals("BUG_FOUND"))
						laddus += Integer.parseInt(tokens[1]);
					else
						laddus += 50;
				}
