...
/**
 * Created by rahulkhairwar on 03/06/16.
 */
class ChefAndBinaryOperation
{
	...
	static class Solver
	{
		...
		void solve(int testNumber)
		{
			...
			while (t-- > 0)
			{
				...
				int zeroes, ones, zeroToOne, oneToZero;

				zeroes = ones = zeroToOne = oneToZero = 0;
				...
				else
				{
					...
					steps = 0;
					min = Math.min(zeroToOne, oneToZero);
