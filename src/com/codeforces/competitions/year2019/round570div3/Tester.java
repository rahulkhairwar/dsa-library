...
public class Tester
{
	public static void main(String[] args)
	{
		...
		List<TestCase> testCases = readTestCases("/Users/rahulkhairwar/Documents/dsa-library/src/com/codeforces/competitions/year2019/round570div3/G.xml");
		...
		for (int i = 0; i < testCases.size(); i++)
		{
			...
			new TaskG(inputStream, outputStream);
